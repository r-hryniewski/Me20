...
namespace Me20.Bot.Dialogs
{
    ...
    public class HelpDialog : IDialog
    {
        ...
        public static async Task Respond(IDialogContext context)
        {
                ...
                await context.PostAsync($"I'm still under development so I can't do much. For now you can ask me to give you some links on chosen topic ('I want to read about coding' or 'give me four links about SQL'). I'll give you some of the newest links that I know of if they're tagged with this particular topic.");
